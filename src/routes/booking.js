...
router.patch('/accept-booking/:id', middlewareController.verifyTokenManager, bookingController.acceptBooking)
router.patch('/cancel-booking/:id', middlewareController.verifyToken, bookingController.cancelBooking)
